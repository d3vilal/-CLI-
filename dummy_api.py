...
app=FastAPI()
servers=[{"id": 1, "title": "main_server", "team":"bird","cluster":"mumbai","plan":"basic","auto_increase_storage": False },
        {"id": 2, "title": "backup_server", "team":"bird","cluster":"mumbai","plan":"basic","auto_increase_storage": False }]
@app.get("/servers")
def get_servers():
    return servers
